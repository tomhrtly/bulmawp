...
function bulmawp_enqueue() {
  wp_enqueue_style('bulma', 'https://cdnjs.cloudflare.com/ajax/libs/bulma/0.7.1/css/bulma.min.css');
  wp_enqueue_style('bulmawp', get_stylesheet_uri());
	wp_enqueue_script('bulmawp-script', get_template_directory_uri() .'/js/script.js', array('jquery'), '1.0', true);
  wp_enqueue_script('fontawesome5', 'https://use.fontawesome.com/releases/v5.0.13/js/all.js', array('jquery'), '1.0', true);
}
...
/* MENU */
function bulmawp_register_menu() {
	register_nav_menu('navbar', 'Navbar Menu');
}
add_action('after_setup_theme', 'bulmawp_register_menu');
