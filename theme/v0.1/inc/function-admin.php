...
require get_template_directory() . '/inc/function-footer.php';
require get_template_directory() . '/inc/function-navbar.php';
require get_template_directory() . '/inc/function-pagination.php';
require get_template_directory() . '/inc/function-search.php';
