            ...
            <div class="field is-grouped">
              ...
              $socialFacebook = esc_attr( get_option( 'social_facebook' ) );
        			if( !empty( $socialFacebook ) ) :
          			echo '<a href="', $socialFacebook, '" class="navbar-item"><span class="icon is-facebook"><i class="fab fa-facebook fa-lg"></i></span></a>';
          		endif;

              $socialTwitter = esc_attr( get_option( 'social_twitter' ) );
        			if( !empty( $socialTwitter ) ) :
          			echo '<a href="', $socialTwitter, '" class="navbar-item"><span class="icon is-twitter"><i class="fab fa-twitter fa-lg"></i></span></a>';
          		endif;

              $socialGoogle = esc_attr( get_option( 'social_google' ) );
        			if( !empty( $socialGoogle ) ) :
          			echo '<a href="', $socialGoogle, '" class="navbar-item"><span class="icon is-googleplus"><i class="fab fa-google-plus fa-lg"></i></span></a>';
          		endif;

              $socialInstagram = esc_attr( get_option( 'social_instagram' ) );
        			if( !empty( $socialInstagram ) ) :
          			echo '<a href="', $socialInstagram, '" class="navbar-item"><span class="icon is-instagram"><i class="fab fa-instagram fa-lg is-instagram"></i></span></a>';
          		endif;

              $socialPinterest = esc_attr( get_option( 'social_pinterest' ) );
        			if( !empty( $socialPinterest ) ) :
          			echo '<a href="', $socialPinterest, '" class="navbar-item"><span class="icon is-pinterest"><i class="fab fa-pinterest fa-lg"></i></span></a>';
          		endif;

              $socialRSS = get_option( 'social_rss' );
              if( $socialRSS == 1 ) :
                echo '<a href="', site_url(), '/feed" class="navbar-item"><span class="icon is-rss"><i class="fas fa-rss fa-lg"></i></span></a>';
              endif;
              ?>
            </div>
          </div>
